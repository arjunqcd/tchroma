// -*- C++ -*-
/*! \file
 *  \brief  gauge action for using continuous beta method of ReverseMC
 */

#ifndef __ReverseMC_gaugeact_h__
#define __ReverseMC_gaugeact_h__
...
namespace Chroma
{
  ...
  { 
	...
	I[3][2] = I[2][3];
      ...
      //Only betas relating to the ReverseMC will be used.
	...
	cgs(cgs_), param(p) {}
      ...
      void setbeta(multi1d<LatticeReal> & input);
